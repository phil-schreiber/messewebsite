					...
					<table class="formTable">
						<tr>
							...
							<td class="alignLeft marginLeft">
								<label for="name"><?php echo messetool\Modules\Modules\Frontend\Controllers\ControllerBase::translate('name'); ?></label>
							</td>
							<td class="alignLeft">								
						...
						<tr>
							<td style="width:13vw;padding:0;margin:0;">&nbsp;</td>
							<td class="alignLeft marginLeft">
								<label for="city"><?php echo messetool\Modules\Modules\Frontend\Controllers\ControllerBase::translate('city'); ?></label>
							</td>
							<td class="alignLeft">								
								<input type="text" name="city" id="searchCity">								
							</td>
							<td class="alignLeft"><input type="submit" value="<?php echo messetool\Modules\Modules\Frontend\Controllers\ControllerBase::translate('search'); ?>"></td>
						</tr>							
						<tr>
