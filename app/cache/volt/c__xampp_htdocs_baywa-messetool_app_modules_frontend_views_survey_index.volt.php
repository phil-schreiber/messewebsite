		...
		<div id="surveyForm" class="form">
			<div id="surveyFormWrapper" class="pt-wrapper">
				...
				<div class="pt-page pt-page-10">
					...
					<br><br>
					<a href="http://agritechnica2015.denkfabrik-group.com/" class="navButton small"  id="consultantNotFound" style="margin-left:30px;float:left"><span class="icon i_right_primary"></span><span class="btn_label"><?php echo messetool\Modules\Modules\Frontend\Controllers\ControllerBase::translate('backHome'); ?></span></a>
				</div>
			</div>
		</div>
