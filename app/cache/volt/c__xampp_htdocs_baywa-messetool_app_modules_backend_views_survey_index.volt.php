		...
		<div id="surveyForm" class="form">
			<div id="surveyFormWrapper" class="pt-wrapper">
				<div class="pt-page pt-page-1 pt-page-current">
					<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyHeaderInfoB'); ?>
						...
						<table class="formTable">
							...
							<tr>
								...
								<td colspan="3" style="text-align:center">
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="3" class="pt-trigger">
				...
				<div class="pt-page pt-page-3">
					...
					<form autocomplete="off" class="survey" name="question_102">
							...
							<tr>
								<td>
									<label for="q_2_3"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_2_5_b'); ?></label>
								</td>
								<td>
									<span class="starRating">
								...
								<td>
									<label for="q_2_4"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_2_6_b'); ?></label>
								</td>
								<td>
									<span class="starRating">
							...
							<tr>
								<td>
									<label for="q_2_3"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_2_7_b'); ?></label>
								</td>
								<td>
									<span class="starRating">
								...
								<td>
									<label for="q_2_4"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_2_8_b'); ?></label>
								</td>
								<td>
									<span class="starRating">
							...
							<tr>
								<td>
									<label for="q_2_3"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_2_9_b'); ?></label>
								</td>
								<td>
									<span class="starRating">
								...
								<td style="text-align:right;">
									<br>
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="4" class="pt-trigger">
										<br>		
								</td>
						...
						<table class="formTable">
							...
							<tr>
								<td colspan="3" style="text-align:center">
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="5" class="pt-trigger">
										<br><br>
								</td>
							</tr>
						</table>
				...
				<div class="pt-page pt-page-5">
					...
					<form autocomplete="off" class="survey" name="question_104">
						<table class="formTable">
							<tr>
								<td>
									<input type="radio" id="q_4_1_b" name="item" value="1"> <label for="q_4_1_b"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_4_1_b'); ?></label>
								</td>
								<td>
									<input type="radio" id="q_4_2_b" name="item" value="2"> <label for="q_4_2_b"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_4_2_b'); ?></label>
								</td>
							...
							<tr>
								<td colspan="2" style="text-align:center">
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="6" class="pt-trigger">
										<br>
								</td>
							</tr>
						</table>
				...
				<div class="pt-page pt-page-6">
					...
					<form autocomplete="off" class="survey" name="question_105">
						<table class="formTable">
							<tr>
								<td>
									<input type="radio" id="q_5_1_b" name="item" value="1"> <label for="q_5_1_b"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_5_1_b'); ?></label>
								</td>
								<td>
									<input type="radio" id="q_5_2_b" name="item" value="2"> <label for="q_5_2_b"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_5_2_b'); ?></label>
								</td>
							...
							<tr>
								<td colspan="3" style="text-align:center">
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="7" class="pt-trigger">
										<br>
								</td>
							</tr>
						</table>
						...
						<table class="formTable">
							...
							<tr>
								<td colspan="3" style="text-align:center">
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="8" class="pt-trigger">
										<br>
								</td>
							</tr>
						</table>
					...
					<form autocomplete="off" class="survey" name="question_107">
						<table class="formTable">
							...
							<tr>
								...
								<td>
									<label for="q_7_6_b"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_7_6_b'); ?></label>
								</td>
								<td>
									<span class="starRating">
										<input type="hidden" name="rating[]" value="6">
							...
							<tr>
								...
								<td colspan="2" style="text-align:center">
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="9" class="pt-trigger">
										<br>
								</td>
							</tr>
					...
					<form autocomplete="off" class="survey" name="question_108">
						<table class="formTable" id="plzTable">
								...
								<td colspan="6" style="text-align:center">
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="10" class="pt-trigger">
										<br>
								</td>
							</tr>
						</table>
					...
					<form autocomplete="off" class="survey" name="question_109">
						<table class="formTable" id="plzTable">
								...
								<td colspan="6" style="text-align:center">
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="11" class="pt-trigger">
										<br>
								</td>
							</tr>
						</table>
				...
				<div class="pt-page pt-page-11">
					...
					<form autocomplete="off" class="survey" name="question_110">
						<table class="formTable" id="plzTable">
								...
								<tr>
									<td>
										<label for="q_10_1_b"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_10_1_b'); ?></label> <input type="text" id="q_10_1_b" name="openitem[]"> 
									</td>							
										<td>
										<label for="q_10_2_b"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_10_2_b'); ?></label> <input type="text" id="q_10_2_b" name="openitem[]"> 
									</td>							
								</tr>
								<tr>
									<td>
										<label for="q_10_3_b"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_10_3_b'); ?></label> <input type="text" id="q_10_3_b" name="openitem[]"> 
									</td>							
										<td>
										<label for="q_10_4_b"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('q_10_4_b'); ?></label> <input type="text" id="q_10_4_b" name="openitem[]"> 
									</td>							
								</tr>
								<tr>
									<td colspan="2">
								...
								<td colspan="6" style="text-align:center">
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="12" class="pt-trigger">
										<br>
								</td>
							</tr>
						</table>
					...
					<form autocomplete="off" class="survey" name="question_111">
						<table class="formTable" id="plzTable">
								...
								<td colspan="6" style="text-align:center">
										...
										<input type="submit" value="<?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('surveyButtonGoon'); ?>" data-animation="32" data-goto="13" class="pt-trigger">
										<br>
								</td>
							</tr>
						</table>
				...
				<div class="pt-page pt-page-13">
					...
					<a href="http://baywa-messetool.iq-pi.org/" class="navButton"  id="consultantNotFound"><span class="icon i_right_primary"></span><span class="btn_label"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('backHome'); ?></span></a>
				</div>
			</div>
		</div>
		<a href="http://baywa-messetool.iq-pi.org/" class="navButton small backToTop"  ><span class="icon i_up_primary"></span><span class="btn_label"><?php echo messetool\Modules\Modules\Backend\Controllers\ControllerBase::translate('backHome'); ?></span></a>
	</section>
